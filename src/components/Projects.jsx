				...
				<Container className="projects">
					<main>
						<section className="projects-text">
							...
							<article>
								<h2 className="projects-heading">Personal Website</h2>
							...
							<article>
								<h2 className="projects-heading">Great Circle Distance Calculator</h2>
							...
							<article>
								<h2 className="projects-heading">Weather App</h2>
								<h4><i>(HTML/CSS, JS)</i></h4>
							...
							<article>
								<h2 className="projects-heading">Recreational Membership Management System</h2>
								<h4><i>(Java)</i></h4>
							...
							<article>
								<h2 className="projects-heading">Library Database Management System</h2>
								<h4><i>(Java, SQL)</i></h4>
							...
							<article>
								<h2 className="projects-heading">Resume Builder</h2>
							...
							<article>
								<h2 className="projects-heading">WoofsUp</h2>
							...
							<article>
								<h2 className="projects-heading">Information Retrieval System</h2>
								<h4><i>(Java)</i></h4>
